    ...
    <>
      ...
      <div className="fixed left-6 top-1/2 -translate-y-1/2 z-20">
        <button
          onClick={onPrev}
          disabled={!hasPrev}
          className="p-3 rounded-full bg-white/80 backdrop-blur-sm shadow-lg border border-gray-200/50 text-gray-600 hover:text-gray-900 hover:bg-white transition-all disabled:opacity-30 disabled:cursor-default cursor-pointer"
